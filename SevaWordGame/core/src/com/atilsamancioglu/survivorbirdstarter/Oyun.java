                ...
                try {
                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        if(str==null){
                            ...
                            if (hak==-176115){
                                System.out.println(" ////////////////////////////////// game over hakkınız kalmadı"+ "total puanınız ==  "+totalpuan+"///////////////////////////////////////////////////////");

                                BitmapFont font = new BitmapFont();
                                font.getData().setScale(7);
                                Gdx.app.error("game over hakkınız kalmadı total puan ", String.valueOf(totalpuan));
                                label3 = new Label(" game over T.puan "+totalpuan, new Label.LabelStyle(font, Color.RED));
                                label3.setPosition(stage.getWidth() - 980, stage.getHeight() - 580);
